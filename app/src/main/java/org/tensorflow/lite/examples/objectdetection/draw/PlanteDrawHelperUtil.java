...
/**
 * 绘制餐盘识别边框类，用于在{@link }上绘制矩形
 */
public class PlanteDrawHelperUtil {
    private final String TAG = "DrawHelperUtil";
    private int previewWidth, previewHeight, canvasWidth, canvasHeight, cameraDisplayOrientation, cameraId;
    private boolean isNameTextMirror;
     ...
     */
    public PlanteDrawHelperUtil(int previewWidth, int previewHeight, int canvasWidth,
        ...
        this.isNameTextMirror = isMirror;
    ...
    public Rect adjustRect(Rect ftRect) {
        //Log.d("11111", "绘制人脸 人脸数据位置 left = " + ftRect.left + " top = " + ftRect.top + " right = " + ftRect.right + " bottom = " + ftRect.bottom);
...
//        Log.d("vinda","cameraDisplayOrientation = "+cameraDisplayOrientation);
...
//        boolean mirrorVertical = this.mirrorVertical;
        ...
        if (cameraDisplayOrientation % 180 == 0) {
            //Log.d(TAG, "cameraDisplayOrientation % 180 == 0");
        ...
        switch (cameraDisplayOrientation) {
            case 0:
                //Log.d(TAG, "cameraDisplayOrientation  == 0");
                ...
                break;
            case 90:
                //Log.d(TAG, "cameraDisplayOrientation  == 90");
                ...
                break;
            case 180:
                //Log.d(TAG, "cameraDisplayOrientation  == 180");
                ...
                break;
            case 270:
                //Log.d(TAG, "cameraDisplayOrientation  == 270");
        ...
        //Log.d(TAG, "处理后的 newRect left = " + newRect.left + " top = " + newRect.top);
        return newRect;
    }
    ...
    public void setNameTextMirror(boolean nameTextMirror) {
        isNameTextMirror = nameTextMirror;
    }
    ...
    public boolean isNameTextMirror() {
        return isNameTextMirror;
    }
     ...
     * @param mirrorVertical           为兼容部分设备使用，垂直再次镜像
     */
    public void updateDrawParams(int previewWidth, int previewHeight, int canvasWidth, int canvasHeight
            , int cameraDisplayOrientation, int cameraId, boolean isMirror
        ...
        this.mirrorHorizontal = mirrorHorizontal;
        this.mirrorVertical = mirrorVertical;
//        Log.d(TAG, "updateDrawParams cameraDisplayOrientation = " + cameraDisplayOrientation + " canvasWidth = " + canvasWidth
